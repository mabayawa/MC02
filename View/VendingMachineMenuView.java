...
public class VendingMachineMenuView extends JPanel{
    JLabel shotPaLabel;
    ...
    JLabel selectedDenominationLabel;
    public VendingMachineMenuView(){
        ...
        for (int i = 1; i <= 12; i++) {
            ...
            ingredientButton = new JButton("Ingredient " + i);
        ...
        selectedDenominationLabel = new JLabel("You have chose these Denomination: ____");
        selectedDenominationLabel.setHorizontalAlignment(JLabel.CENTER);
        selectedDenominationLabel.setFont(new Font("Arial", Font.PLAIN, 16));
        selectedDenominationLabel.setForeground(Color.black);
        ...
        selectionPanel.add(selectedDenominationLabel, BorderLayout.NORTH);
    ...
    public JLabel getSelectedDenomination(){
        return this.selectedDenominationLabel;
    }
}
